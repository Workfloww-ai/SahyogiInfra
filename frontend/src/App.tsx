...
const Logo = ({ className = "" }: { className?: string }) => (
  <div className={`relative flex items-center justify-center ${className}`}>
    <img
      ...
      className="h-10 w-auto md:h-18 object-contain drop-shadow-sm"
    />
  </div>
);
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="pt-12 border-t border-sand/10 flex flex-col md:flex-row justify-between items-center gap-6 font-sans text-[10px] uppercase tracking-widest text-sand/40">
                ...
                <div className="flex gap-8">
                  <a href="/privacy.html" rel="noopener noreferrer" className="hover:text-sand transition-colors">Privacy Policy</a>
